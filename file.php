...
<div>
    ...
    <div class="text">
    <p>Я, субъект персональных данных, в соответствии с Федеральным законом от 27 июля 2006 года № 152 «О персональных 
    данных» предоставляю НАИМЕНОВАНИЕ ЮР. ЛИЦА (далее - Оператор), расположенному по адресу город, улица, дом 
    (юр. адрес), согласие на обработку персональных данных, указанных мной в где происходит ввод данных данных 
    (контактаная форма, обартный звонок...) на сайте адрес сайта в сети «Интернет», владельцем которого является Оператор.</p>
<p>1. Состав предоставляемых мной персональных данных является следующим: ФИО, адрес электронной почты и номер телефона. (дополнить при необходимости или урезать) </p>
<p>2. Целями обработки моих персональных данных являются: обеспечение функционирования где происходит ввод данных данных (контактаная форма, обартный звонок...). </p>
